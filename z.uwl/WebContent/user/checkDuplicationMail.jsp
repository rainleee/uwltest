	...
	<script type="text/javascript">
		...
		$(function () {
			...
			$("button#checkMail").on("click" , function() {
				...
				if( $("#mail").val() != null && $("#mail").val().length >0) {
				    ...
				    $("form").attr("action" , "/user/checkDuplicationMail");
				    $("form").submit();
				}else {
		...
		$(function() {
			...
			$("button.btn.btn-success").on("click" , function() {
				...
				if(opener) {
					opener.$("input[name='mail']").val("${mail}");
	...
	<div class="container">
		...
		<form class="form-inline">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" name="mail" id="mail"  placeholder="메일"
		    																		value="${ ! empty result && result ? mail : '' }" >
		  </div>
